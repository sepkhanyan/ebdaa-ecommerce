...
/**
 * Order Vendor e-mail controller factory.
 *
 * @package Controller
 * @subpackage Order
 */
    ...
    implements \Aimeos\Controller\Jobs\Common\Factory\Iface
{
    ...
    public static function create( \Aimeos\MShop\Context\Item\Iface $context, \Aimeos\Bootstrap $aimeos, string $name = null ) : \Aimeos\Controller\Jobs\Iface
    {
        ...
        if( $name === null ) {
            $name = $context->getConfig()->get( 'controller/jobs/order/email/Vendor/name', 'Standard' );
        }

        $iface = '\\Aimeos\\Controller\\Jobs\\Iface';
        $classname = '\\Aimeos\\Controller\\Jobs\\Order\\Email\\Vendor\\' . $name;
        ...
        return self::addControllerDecorators( $context, $aimeos, $controller, 'order/email/vendor' );
    }
}

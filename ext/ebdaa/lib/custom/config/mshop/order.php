                    ...
                    'update' => array(
                        'ansi' => '
							...
							SET :names
								...
								"taxflag" = ?, "pos" = ?, "mtime" = ?, "editor" = ?, "final_costs" = ?, "delivery_type" = ?
							WHERE "siteid" = ? AND "id" = ?
						'
                    ),
                    'search' => array(
                        ...
                        'mysql' => '
							SELECT :columns
								...
								mordbase."taxflag" AS "order.base.service.taxflag", mordbase."pos" AS "order.base.service.position",
								mordbase."mtime" AS "order.base.service.mtime", mordbase."editor" AS "order.base.service.editor",
								mordbase."ctime" AS "order.base.service.ctime", mordbase."final_costs" AS "order.base.service.final.costs",
								mordbase."delivery_type" AS "order.base.service.delivery.type"
							FROM "mshop_order_base_service" AS mordbase
							:joins
							WHERE :cond
							GROUP BY :columns :group

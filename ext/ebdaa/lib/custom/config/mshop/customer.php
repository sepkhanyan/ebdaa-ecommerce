 ...
 */
//original file taken from https://raw.githubusercontent.com/aimeos/ai-laravel/master/lib/custom/config/mshop/customer.php
//570 and 590 line number it
//572 and 596 added i.e lvu."editor" AS "customer.editor",lvu."mobile" AS "customer.mobile"
			...
			'search' => array(
				'ansi' => '
					SELECT DISTINCT :columns
						...
						lvu."editor" AS "customer.editor",lvu."mobile" AS "customer.mobile"
					FROM "users" AS lvu
					:joins
					WHERE :cond
					ORDER BY :order

            ...
            'insert' => array(
                'ansi' => '
					INSERT INTO "mshop_price" ( :names
						...
						"status", "mtime", "editor", "cost_price", "commission", "siteid", "ctime"
					) VALUES ( :values
						?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?
					)
				'
            ...
            'search' => array(
                ...
                'mysql' => '
					SELECT DISTINCT :columns
						...
						mpri."taxrate" AS "price.taxrates", mpri."status" AS "price.status",
						mpri."mtime" AS "price.mtime", mpri."editor" AS "price.editor",
						mpri."ctime" AS "price.ctime", mpri."cost_price" AS "price.cost_price",
						mpri."commission" AS "price.commission"
					FROM "mshop_price" AS mpri
					:joins
					WHERE :cond
					ORDER BY :order

...
Aimeos.Order = {
    ...
    init : function() {
        ...
        // this.toggleAddressForm(); //Commented edit option of address form
    ...
    createShortAddress : function() {
        ...
        $(".aimeos .item-order .item-address").each(function() {
            ...
            node.html(sprintf(format,
                '<b>Building Type</b>:'+'<span class="company">' + $("[data-field=company]", form).val() + '</span>',
                '<b>Full name</b>:'+'<span class="firstname">' + $("[data-field=firstname]", form).val() + '</span>',
                '<span class="lastname">' + $("[data-field=lastname]", form).val() + '</span>',
                '<br><b>Area: </b>'+'<span class="area">' + $("[data-field=area]", form).val() + '</span>',
                '<b>Building No: </b>'+'<span class="address2">' + $("[data-field=address2]", form).val() + '</span>',
                '<br><b>State: </b>:'+'<span class="state">' + $("[data-field=state]", form).val() + '</span>',
                '<b>Street: </b>'+'<span class="address1">' + $("[data-field=address1]", form).val() + '</span>',
                // '<span class="postal">' + $("[data-field=postal]", form).val() + '</span>',
                // '<b>City</b>:'+'<span class="city">' + $("[data-field=city]", form).val() + '</span>',
                // '<span class="countryid">' + $("[data-field=countryid]", form).val() + '</span>',
                // '<b>Email</b>:'+'<span class="email">' + $("[data-field=email]", form).val() + '</span>',
                '<b>Mobile: </b>:'+'<span class="telephone">' + $("[data-field=telephone]", form).val() + '</span>',

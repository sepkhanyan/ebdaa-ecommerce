 ...
 */
$navlimit = $this->config( 'admin/jqadm/product/item/navbar-limit', 8 );
	...
	<div class="row item-container">
		...
		<div class="col-md-3 item-navbar">
			<ul class="nav nav-tabs flex-md-column flex-wrap d-flex justify-content-between" role="tablist">
                <li class="nav-item">
                    <a class="nav-link" href="#import_csv" data-toggle="tab" role="tab" aria-expanded="true" aria-controls="basic">
                        <?= $enc->html( $this->translate( 'admin', 'Import csv' ) ); ?>
                    </a>
                </li>
		...
		<div class="col-md-9 item-content tab-content">
            ...
            <div id="import_csv" class="row item-basic tab-pane fade" role="tabpanel" aria-labelledby="import_csv">
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="customCsvInput">
                        <input type="hidden"  id="site_name" value="<?= $params['site'] ?>">
                        <label class="custom-file-label" for="customCsvInput" id="import_csv_label">Choose file</label>
                    </div>

                    <div class="csv-button">
                        <a class="btn btn-primary mt-2" id="send_csv">
                            <span>Import Product Data</span>
                        </a>

                        <a class="btn btn-primary mt-2" id="send_csv_loader">
                            <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                            <span>Import Product Data</span>
                        </a>

                        <a class="btn btn-primary mt-2 ml-2" id="media_scale">Media scale</a>
                    </div>


                    <div class="csv_error_message">
                        <!--error message here-->
                    </div>
